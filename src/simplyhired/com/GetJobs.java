...
//	static int firstTime  = 0;
		...
		public static void main(String[] args) {
			...
			String urlForJob = "http://www.simplyhired.co.in/a/jobs/list/q-Accounting";
	...
	public static  ArrayList<String> FetchjobsFromJobPortal(String urlForJob)
	{
		...
		for(int i = 0 ; i < listOfHref.size() ;i++)
		{
			    ...
			    if(listOfHref.get(i).getAttribute("class").equals("next"))
			    {
				    try
					{
						 ...
						 List<WebElement>        listOfDiv1   =  driver1.findElements(By.xpath("//li[contains(@class,'result')]"));
						 ...
						 for(; j < listOfDiv1.size() ; j++)
							{ 
								    ...
								    FileWriteUsingAppendMode("/home/amit/Desktop/simplyhiredjobs.txt",listOfDiv1.get(j).getText()+"\n");
									FileWriteUsingAppendMode("/home/amit/Desktop/simplyhiredjobs.txt","-----------------------------------------------\n");
									 
							}
						
					     
						 // reload page with link of next
						 try{
				    ...
				    i=0; // reset variable to make pagination iterable again to reload arraylist of links for pagination
			    }// if close
