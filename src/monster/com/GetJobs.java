...
public class GetJobs {
   public static void main(String[] args) {
	   ...
	   String urlForJob = "http://jobsearch.monster.com/browse/?re=nv_gh_gnl1147_%2Fbrowse%2F";
			GetJobs.FetchjobsFromJobPortal(urlForJob);	
		}// main close
	...
	public static  ArrayList<String> FetchjobsFromJobPortal(String urlForJob)
	{
	    ...
	    WebElement             divForJobs =  driver1.findElement(By.xpath("//div[contains(@class,'navigationBar')]"));
		List<WebElement>       listOfHref =  divForJobs.findElements(By.tagName("a"));
		
		for(int i = 0 ; i < listOfHref.size() ; i++)
		{
			
			    //System.out.println(listOfHref.get(i).getAttribute("href"));
			    if(listOfHref.get(i).getText().contains("Next"))
			    {
				    try
					{
				    	 ...
				    	 List<WebElement>        listOfDiv1  =  driver1.findElements(By.xpath("//tr[contains(@class,'odd')]"));
				    	 List<WebElement>        listOfDiv2  =  driver1.findElements(By.xpath("//tr[contains(@class,'even')]"));
						 ...
						 for(int j = 0 ; j < listOfDiv1.size() ; j++)
							{ 
								  ...
								  //FileWriteUsingAppendMode("/home/amit/Desktop/monsterjobs.txt",listOfDiv1.get(j).getText()+"\n");
								  //FileWriteUsingAppendMode("/home/amit/Desktop/monsterjobs.txt","-----------------------------------------------\n");
								 
							}
						 
						 for(int j = 0; j < listOfDiv2.size() ; j++)
							{ 
								  System.out.println("---------------------------------------------------------------");
							      System.out.println(listOfDiv2.get(j).getText());
								  listOfJobs.add(listOfDiv2.get(j).getText());
								  //FileWriteUsingAppendMode("/home/amit/Desktop/monsterjobs.txt",listOfDiv1.get(j).getText()+"\n");
								  //FileWriteUsingAppendMode("/home/amit/Desktop/monsterjobs.txt","-----------------------------------------------\n");
								 
				   		    }
						  
						 System.out.println(listOfJobs.size()+"jobs are got from this link :"+listOfHref.get(i).getAttribute("href"));
					     try
					     {
				    	...
				    	divForJobs =  driver1.findElement(By.xpath("//div[contains(@class,'navigationBar')]"));
